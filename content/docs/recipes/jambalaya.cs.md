...
title = "Jambalaya"
type = "docs"
tags = ["oběd", "jednoduché", "pod 2 hodiny"]
categories = ["recept"]
date = 2025-12-23T04:47:50+01:00
+++
...
- 2 cibule
- 2 červené papriky
- dlouhozrnná rýže (basmati)
- naťový celer
- česnek
- tuk
- olivový olej
- zahuštěný rajský protlak (v tubě)
- slepičí vývar
- [cajunské koření][cajunspice]
...
3. ### Uvařit rýži
    ...
    - zalít vývarem
    - přidat zahuštěný rajský protlak
    - přidat zbytek koření
    - uvařit (podle rýže)
...
4. ### Redukovat, dochutit
    ...
    - dosolit
    - přidat usmažené maso aby se v tom jen ohřálo, už ho dál nevařit
{{% /steps %}}
